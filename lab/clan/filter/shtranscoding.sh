...
timestamp=$(date +%s)
outputvideo=/opt/application/tx-rtcStream/files/synthesis/c-${timestamp}.mp4
...
# RTMP 生成文件
./transcoding /opt/application/tx-rtcStream/files/resources/office10s.mp4 ${outputvideo}
